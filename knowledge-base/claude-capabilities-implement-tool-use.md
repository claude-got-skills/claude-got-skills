...
We recommend using the latest Claude Sonnet (4.5) or Claude Opus (4.6) model for complex tools and ambiguous queries; they handle multiple tools better and seek clarification when needed.
...
| Vertex AI,<br/>Amazon Bedrock | `tool-examples-2025-10-29` | Claude Opus 4.6 only |
</Info>
...
- Claude Opus 4.6, Opus 4.1, and Sonnet 4: Excel at parallel tool use with minimal prompting
